...
/// Türkiye'deki 81 ilin Su ve Kanalizasyon İdaresi (2025 güncel)
const List<WaterUtility> waterUtilities = [
  // 30 Büyükşehir İlleri
  WaterUtility(
    code: "ISKI",
...
// İl adına göre hızlı erişim haritası (case-insensitive)
...
// İl adına göre su idaresi bulma
...
/// Türkiye'deki Doğal Gaz Dağıtım Şirketleri (2025 güncel - EPDK/GAZBİR)
...
/// Türkiye'deki İnternet Servis Sağlayıcıları (2025 güncel - BTK)
...
// Sağlayıcı adına göre hızlı erişim
...
// İnternet sağlayıcı kodu ile arama
...
// İsme göre internet sağlayıcı bulma

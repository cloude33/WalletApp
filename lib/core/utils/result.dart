...
/// Future Result için extension metodları
extension FutureResultExtension<T> on Future<Result<T>> {
  Future<Result<U>> map<U>(U Function(T data) transform) async {
  ...
  Future<Result<U>> flatMap<U>(Result<U> Function(T data) transform) async {
    final result = await this;

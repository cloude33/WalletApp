...
/// Error codes for credit card operations
/// 
/// Note: Using UPPER_SNAKE_CASE for error codes is a common convention
/// and improves readability when used as constants throughout the codebase.
class ErrorCodes {
  // ==================== VALIDATION ERRORS ====================

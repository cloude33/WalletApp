...
class AndroidBiometricService implements PlatformBiometricService {
  ...
  AuthResult _handleAndroidPlatformException(PlatformException e) {
    ...
    switch (e.code) {
      case 'NotAvailable':
        errorMessage =
            'Android cihazda biyometrik kimlik doğrulama mevcut değil';
        break;
      case 'NotEnrolled':
        errorMessage =
            'Android cihazda kayıtlı biyometrik veri bulunamadı. Lütfen cihaz ayarlarından biyometrik doğrulamayı etkinleştirin';
        break;
      case 'LockedOut':
        errorMessage =

    ...
    try {
      ...
      final bool didAuthenticate = await _localAuth.authenticate(
        ...
        options: const local_auth.AuthenticationOptions(
          ...
          stickyAuth:
              true, // Kullanıcı uygulamayı arka plana aldığında auth devam etsin
          sensitiveTransaction: true, // Hassas işlem olarak işaretle
          useErrorDialogs: true, // Hata dialoglarını göster
        ),
      );

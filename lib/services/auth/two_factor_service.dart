...
/// 
/// This service provides comprehensive two-factor authentication functionality
/// including SMS/Email verification, TOTP (Time-based One-Time Password) support,
/// and backup codes management. It implements requirements 7.4 and 8.3 from
...
/// - Secure storage of 2FA configuration
...
class TwoFactorService {
  ...
  static const String _defaultIssuer = 'Para Yönetimi';
  ...
  Future<void> _storePendingVerification(TwoFactorMethod method, String code) async {
    try {
      ...
      await _secureStorage.storePINRecoveryState(dataJson);
    } catch (e) {
  ...
  Future<String?> _getPendingVerification(TwoFactorMethod method) async {
    try {
      final dataJson = await _secureStorage.getPINRecoveryState();
  ...
  Future<void> _clearPendingVerification() async {
    try {
      await _secureStorage.clearPINRecoveryState();
    } catch (e) {

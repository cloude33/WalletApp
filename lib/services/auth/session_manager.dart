...
/// 
/// Bu servis oturum zaman aşımı kontrolü, arka plan/ön plan geçiş yönetimi
/// ve otomatik kilitleme mekanizmalarını yönetir.
/// 
/// Özellikler:
/// - Oturum zaman aşımı kontrolü
/// - Arka plan/ön plan geçiş yönetimi
/// - Otomatik kilitleme mekanizması
/// - Oturum durumu takibi
/// - Aktivite tabanlı oturum uzatma
/// 
/// Implements Requirements:
/// - 6.1: Uygulama arka plana geçtiğinde oturum zamanlayıcısını başlatmalı
...
/// - 6.4: Hassas ekranlarda bulunulduğunda 2 dakika sonra kilitleme yapmalı
/// - 6.5: Kullanıcı ayarlardan değiştirdiğinde özelleştirilebilir zaman aşımı uygulamalı

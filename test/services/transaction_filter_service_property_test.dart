...
void main() {
  ...
  group('TransactionFilterService Property Tests', () {
    late TransactionFilterService service;

    setUp(() async {
      service = TransactionFilterService();
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      ...
      property: (data) async {
        ...
        final filtered = service.filterByCard(allTransactions, targetCardId);
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      ...
      property: (data) async {
        ...
        final filtered = service.filterByCards(allTransactions, selectedCardIds);

        // Property 1: All filtered transactions should belong to selected cards
        final allBelongToSelectedCards =
            filtered.every((t) => selectedCardIds.contains(t.cardId));
        expect(allBelongToSelectedCards, isTrue,
        ...
        final noUnselectedCards =
            filtered.every((t) => selectedCardIds.contains(t.cardId));
        expect(noUnselectedCards, isTrue,
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      ...
      property: (data) async {
        ...
        final calculatedTotal = service.calculateFilteredTotal(transactions);
        ...
        expect(difference, lessThan(0.0001),
            reason:
    ...
    PropertyTest.forAll<Map<String, dynamic>>(
      description:
          'Property 36: Clear filter should return all transactions',
      generator: () {
      ...
      property: (data) async {
        ...
        // Clear filter
        final cleared = service.clearFilter(transactions);

        // Property 1: Cleared list should have same count as original
        expect(cleared.length, equals(originalCount),
        ...
        expect(noExtras, isTrue,
            reason: 'Cleared list should not contain extra transactions');

        // Property 4: Empty filter with empty list should return empty list
        final emptyCleared = service.clearFilter([]);
        expect(emptyCleared.isEmpty, isTrue,

...
void main() {
  group('AuthService', () {
    ...
    test('should create auth state models correctly', () {
      ...
      expect(authState.authMethod, equals(AuthMethod.pin));
    });
    ...
    test('should handle auth method enum correctly', () {
      ...
      expect(AuthMethod.pin.toJson(), equals('pin'));
    ...
    test('should create auth result models correctly', () {
      ...
      expect(successResult.method, equals(AuthMethod.pin));
    ...
    test('should handle security config correctly', () {
      ...
      final invalidConfig = config.copyWith(maxPINAttempts: 0);
      final invalidValidation = invalidConfig.validate();
      expect(invalidValidation, isNotNull); // Should be invalid
    });
  });
}
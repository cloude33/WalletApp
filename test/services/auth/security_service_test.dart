...
void main() {
  ...
  group('SecurityService Tests', () {
    ...
    test('should log security events', () async {
      ...
      final event = SecurityEvent.pinCreated(
        userId: 'test_user',
        metadata: {'test': 'data'},
      );
  ...
  group('SecurityEvent Tests', () {
    test('should create PIN events correctly', () {
      final event = SecurityEvent.pinCreated(
        userId: 'test_user',
        metadata: {'test': 'data'},
      );

      expect(event.type, SecurityEventType.pinCreated);
      expect(event.userId, 'test_user');
      expect(event.severity, SecurityEventSeverity.info);
      expect(event.source, 'PINService');

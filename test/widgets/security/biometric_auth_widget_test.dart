...
import 'package:money/widgets/security/biometric_auth_widget.dart';
...
void main() {
  group('BiometricAuthWidget', () {
    ...
    testWidgets('should call onAuthSuccess when authentication succeeds', (tester) async {
    ...
    testWidgets('should call onAuthFailure when authentication fails', (tester) async {
    ...
    testWidgets('should show fallback button when onFallbackToPIN is provided', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BiometricAuthWidget(
    ...
    testWidgets('should call onFallbackToPIN when fallback button is tapped', (tester) async {
    ...
    testWidgets('should disable authentication when enabled is false', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BiometricAuthWidget(
    ...
    testWidgets('should show multiple biometric types when available', (tester) async {
  ...
  group('BiometricAuthState', () {
    test('should have all required states', () {
      ...
      expect(BiometricAuthState.values, contains(BiometricAuthState.authenticating));
      ...
      expect(BiometricAuthState.values, contains(BiometricAuthState.notAvailable));
    });
  });
